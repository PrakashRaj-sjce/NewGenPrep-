...
export default function CandidateLogin() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white flex flex-col items-center justify-center px-4">
      ...
      {/* Heading */}
      <h1 className="text-3xl font-bold text-cyan-400 mb-2">Candidate Login</h1>
      <p className="text-gray-400 mb-8">Practice interviews and improve your skills with AI feedback</p>
